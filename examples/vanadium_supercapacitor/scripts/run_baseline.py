...
from leakproof_ml.utils import save_results_as_json
...
for model in model_class:
    ...
    # Simple split
    trainTest = train_test_analysis(X, y, model, random_cv_splitter, feature_selection = True) # With Outliers
    trainTest_removed = train_test_analysis(X_removed, y_removed, model, random_cv_splitter, feature_selection = True) # Without Outliers
    # Random CV
